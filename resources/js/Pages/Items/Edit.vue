                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <input type="radio" id="is_selling" name="is_selling" value="1" v-model="form.is_selling" class="">
                                    <label class="ml-2 mr-5">販売中</label>
                                    <input type="radio" id="is_selling" name="is_selling" value="0" v-model="form.is_selling" class="">
                                    <label>停止中</label>
                                  </div>
                                </div>
